...
export const SHORTCUTS: ShortcutDoc[] = [
  ...
  { keys: 'H', label: 'Hide or show all drawings', scope: 'Drawings' },
  { keys: 'V', label: 'Cursor tool', scope: 'Drawings' },
  { keys: 'T', label: 'Text tool', scope: 'Drawings' },
  { keys: 'Esc', label: 'Cancel drawing / close dialog / exit fullscreen', scope: 'Global' },
  { keys: 'Ctrl (⌘) + Z', label: 'Undo', scope: 'Drawings, trading' },
  { keys: 'Shift + Ctrl (⌘) + Z', label: 'Redo', scope: 'Drawings, trading' },
  { keys: 'Space', label: 'Play / pause Bar Replay', scope: 'Replay' },
  { keys: 'R', label: 'Restart replay at the start point', scope: 'Replay' },
  { keys: '→', label: 'Step one bar', scope: 'Replay' },
